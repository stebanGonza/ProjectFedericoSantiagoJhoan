...
public abstract class CustodiaFija extends ServicioSeguridad{

    private double calcularCostoMensual;

    public CustodiaFija(String codigocontrato, String cliente, double tarifaMensual, double calcularCostoMensual) {
